...
const rsptButtons = addKeyword(['Postres🍮','Stevia en Pote🥄🌿','Stevia en Sachets📦🌿, Comprar EndulVida🛒, Asesoría/Información📝'])
    .addAnswer('¡Perfecto!🤩 En breves una asesora de ventas te ayudará a terminar tu compra🛒')

// const rsptButtonsCatalogo = addKeyword(['Comprar EndulVida🛒, Asesoría/Información📝'])
//     .addAnswer('¡Perfecto!🤩 En breves una asesora de ventas te ayudará a terminar tu compra🛒')
